...
if (!empty($_SESSION['auth'])) {
    ...
    if (!empty($_POST)) {
        ...
        if (!empty($user) && $username !== $new_username) {
            ...
            if (5 < strlen($new_password) && strlen($new_again_password) < 10) {
                ...
                $add_user_query = "UPDATE users SET
                 name = '$new_name',
                 surname = '$new_surname',
                ...
                if (!empty($_FILES) && $_FILES['avatar']['size'] > 0) {
                    if ($_FILES['avatar']['size'] > 1048576) {
                        ...
                        $_SESSION['update'] = 'Данные аккаунта изменены';
                        die();
                    }
                } else {
                    mysqli_query($link, $add_user_query) or die(mysqli_error($link));
    ...
    <head>
        ...
        <title>Измененить аккаунк</title>
    </head>
                ...
                <form class="row form-control p-4 gy-3" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="name"
                               class="form-control <?= !empty($_POST['name']) ? 'is-valid' : '' ?>"
                               id="validationDefault02" value="<?= $name ?>"
                               required>
                    </div>
                    <div class="col">
                        ...
                        <input type="text" name="surname"
                               ...
                               id="validationDefault03" value="<?= $surname ?>"
                               required>
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <input type="password" name="again_password" class="form-control" id="validationDefault06"
                               required>
                    </div>
                    <div class="col mt-5">
                        <input type="submit" class="btn btn-info light w-100 d-block" value="Изменить данные">
                    </div>
                    <div class="col">
                    </div>
                </form>
